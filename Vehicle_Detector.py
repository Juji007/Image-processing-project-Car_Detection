...
# ## Image processing project phase 2 (Car Detection)
# ## We are:
...
usage ="""
    ...
    How to use ::
    1-run Vehicle_Detector.py file via anaconda cmd
...
def main():
    ...
    if args['-v']:
        Inpath = VideoFileClip(input)
        project_video_clip = Inpath.fl_image(process_image)
        project_video_clip.write_videofile(output,fps=20,audio=False,preset='ultrafast')
